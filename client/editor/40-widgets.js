...
var WIDGET_TYPES={key:{label:"Regular Key",defaults:{w:1,h:1,color:"#0f3460",action:"turbo"}},touchpad:{label:"Touch Pad",defaults:{w:4,h:3,color:"#2a3a5a",action:"touchpad"}},visualizer:{label:"Audio Visualizer",defaults:{w:4,h:2,color:"#0a1a10",action:"visualizer"}},balance:{label:"Deepseek Balance",defaults:{w:4,h:1,color:"#1a1405",action:"balance"}},visualizer:{label:"Audio Visualizer",defaults:{w:4,h:2,color:"#0d1117",action:"visualizer"}},balance:{label:"Deepseek Balance",defaults:{w:4,h:1,color:"#0d1117",action:"balance"}}};function addKeyOfType(type){
  var page=cp_();if(!page)return;
