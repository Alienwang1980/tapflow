...
function _icThumb(nm,cl){return '<label>&#x263A; Icon</label><div style="display:flex;align-items:center;gap:8px;margin:2px 0 6px"><div style="width:34px;height:34px;flex:0 0 auto;display:flex;align-items:center;justify-content:center;background:var(--bg);border:1px solid var(--border);border-radius:4px;color:'+hesc(cl)+'">'+((window.TAPFLOW_ICONS&&window.TAPFLOW_ICONS.svg[nm])||"").replace('<svg ','<svg style="width:70%;height:70%;display:block" ')+'</div></div>'}
